/* Archivo: pages/Semesters/Create.tsx   Proposito: Pagina para crear registros de Semesters.*/
...
const CreateSemester = () => {
  ...
  const handleCreateSemester = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const createdSemester = await semesterService.createSemester(formData);
      if (createdSemester) {
        Swal.fire({
          title: 'Completado',
        ...
        Swal.fire({
          title: 'Error',
          text: 'Existe un problema al momento de crear el semestre',
          icon: 'error',
          timer: 3000,
        });
      }
